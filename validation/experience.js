...
module.exports = function validate_experience_input(user_input) {
   ...
   user_input.title = is_empty(user_input.title) ? '' : user_input.title
   user_input.company = is_empty(user_input.company) ? '' : user_input.company
   ...
   if (validator.isEmpty(user_input.title)) {
      errors.title = 'Job title is required.'
   }
   if (validator.isEmpty(user_input.company)) {
